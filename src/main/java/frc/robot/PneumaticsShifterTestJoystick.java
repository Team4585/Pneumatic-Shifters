...
public class PneumaticsShifterTestJoystick extends HuskyJoystick{
  private static final int PneumaticsShifterTest_JOYSTICK_PORT = 0;
  ...
  public PneumaticsShifterTestJoystick(){
      super(PneumaticsShifterTest_JOYSTICK_PORT);
  }
